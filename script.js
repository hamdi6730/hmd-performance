...
formPlaque?.addEventListener("submit", (e) => {
  ...
  showLoaderAndExecute(async () => {
    try {
      const response = await fetch(`https://api-plaque-immatriculation-siv.p.rapidapi.com/get-vehicule-info?token=TokenDemoRapidapi&host_name=https%3A%2F%2Fapiplaqueimmatriculation.com&immatriculation=${clean}`, {
        method: 'GET',
        headers: {
